        ...
        <div className="works-container">
          <a href="https://uiux-personas.herokuapp.com/" className="work-item">
            <div className="image-container">
              <img src={ss4} className="item-image" />
              <h2>Personas</h2>
              <p>
          ...
          <a href="https://resp-redesign.herokuapp.com/" className="work-item">
            <div className="image-container">
              <img src={ss1} className="item-image" />
          ...
          <a href="https://uiux-abtesting.herokuapp.com/" className="work-item">
            <div className="image-container">
              <img src={ss3} className="item-image" />
              <h2>A/B Testing</h2>
              <p>
          ...
          <a href="https://uiux-dev.herokuapp.com/" className="work-item">
            <div className="image-container">
              <img src={ss2} className="item-image" />
              <h2>Development</h2>
              <p>
                <i>Creating React Components</i>
              </p>
              <p>
                Created a list interface. Added aggregating, filtering,
